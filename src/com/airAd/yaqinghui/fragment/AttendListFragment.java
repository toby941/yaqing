...
public class AttendListFragment extends ListFragment {
    ...
    public static AttendListFragment newInstance(ArrayList<ScheduleItem> itemList, ImageFetcher fetcher) {
        final AttendListFragment f = new AttendListFragment();
        // f.mImageFetcher = fetcher;
        f.itemList = itemList;
        return f;
    }

    private AttendListFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_attendlist, container, false);
        return v;
    }
